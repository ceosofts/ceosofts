...
function getBaseUrl()
{
    ...
    $arr = explode('assets', $pathInfo['dirname']);
    $project_dir = $arr[0];
    
    // return: http://localhost/myproject/
    return array('url'=>$protocol.$hostName. $project_dir, 'path' => $project_dir);
}

$project = getBaseUrl();
$files_path = $project['path'] . 'assets/userfiles/content';
$baseUrl = $project['url'] . 'assets/userfiles/content';

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl,
	'root'         => $_SERVER["DOCUMENT_ROOT"] . $files_path, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
