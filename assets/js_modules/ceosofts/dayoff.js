...
var Dayoff = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('ceosofts/dayoff/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('ceosofts/dayoff/save');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						window.location = site_url('ceosofts/dayoff');
					}
				},
				error : function(jqXHR, exception){
					ajaxErrorMessage(jqXHR, exception);
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('ceosofts/dayoff/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('ceosofts/dayoff/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url(Dayoff.current_path));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	$('#btnSaveEdit').click(function() {
		return Dayoff.validateFormEdit();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Dayoff.current_page = Math.abs(param_current_page);
	}

	if(typeof param_current_path != 'undefined'){
		Dayoff.current_path = param_current_path;
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Dayoff.confirmDelete(pId,  row_num);
	});//click
	...
	$(document).on('click','.btn[onclick-action]', function(){
		var action_url = site_url('ceosofts/dayoff/' + $(this).attr('onclick-action'));
