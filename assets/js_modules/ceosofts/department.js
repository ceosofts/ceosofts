...
var Department = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('ceosofts/department/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('ceosofts/department/save');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						window.location = site_url('ceosofts/department');
					}
				},
				error : function(jqXHR, exception){
					ajaxErrorMessage(jqXHR, exception);
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('ceosofts/department/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('ceosofts/department/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url(Department.current_path));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	if(typeof param_current_path != 'undefined'){
		Department.current_path = param_current_path;
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Department.confirmDelete(pDpmId,  row_num);
	});//click
	...
	$(document).on('click','.btn[onclick-action]', function(){
		var action_url = site_url('ceosofts/department/' + $(this).attr('onclick-action'));
