...
var Mycom = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('ceosofts/mycom/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('ceosofts/mycom/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('ceosofts/mycom/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('ceosofts/mycom/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url(Mycom.current_path));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	if(typeof param_current_page != 'undefined'){
		Mycom.current_page = Math.abs(param_current_page);
	}

	if(typeof param_current_path != 'undefined'){
		Mycom.current_path = param_current_path;
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Mycom.confirmDelete(pId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		Mycom.deleteRecord();
	});
	setDropdownList('#mycom_branch');
	...
	$(document).on('click','.btn[onclick-action]', function(){
		var action_url = site_url('ceosofts/mycom/' + $(this).attr('onclick-action'));
