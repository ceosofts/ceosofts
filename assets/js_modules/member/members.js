...
var Members = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('member/members/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('member/members/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('member/members/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('member/members/del');
...
$(document).ready(function() {
	...
	$(document).on('click','.btn[onclick-action]', function(){
		var action_url = site_url('member/members/' + $(this).attr('onclick-action'));
