 ...
 */
class Forgot_password_only extends CRUD_Controller
{
    ...
    protected function render_view($path)
    {
        ...
        $this->parser->parse('template/' . $template_name . '/homepage_only_view', $this->data);
    }
    ...
    public function process()
    {
        ...
        if ($frm->run() == FALSE) {
            ...
            if (empty($row)) {
                ...
                $url = site_url('member/forgot_password_only/re_pass/' . $key_encode);
    ...
    public function process_reset()
    {
        ...
        if ($frm->run() == FALSE) {
            ...
            if ($new_pass != $new_pass1) {
                ...
                $data = array(
                    'password2' => $new_pass, 'referral_code' => $referral_code
                );
