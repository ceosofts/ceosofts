...
<form class="form-signin" role="form" method="post" id="frm_login" onsubmit="return LogIn();return false;" autocomplete="off">
    ...
    <br />
    <a href="<?php echo site_url('member/forgot_password_only/question'); ?>" class="btn btn-lg btn-block btn-secondary">
        <i class="fas fa-undo fa-x2"></i> ลืมรหัสผ่าน ??</i>
    </a>
    <a href="<?php echo site_url('member/forgot_password_only'); ?>" class="btn btn-lg btn-block btn-warning">
        <i class="fas fa-undo fa-x2"></i> ลืมรหัสผ่าน ด้วย Email ??</i>
    </a>
    <a href="<?php echo site_url('member/regis_only'); ?>" class="btn btn-lg btn-block btn-success"><i class="fas fa-user-edit"></i> ลงทะเบียนสมาชิกใหม่!
    </a>
