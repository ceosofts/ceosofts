	...
	<div class="card-body p-3">
		...
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='input-group'>
					...
					<div class='col-sm-4'>
						<!--
							...
							-->
						<button class="btn btn-warning" data-toggle="modal" data-target="#modal_reset_member_pass" type="button"><i class="fas fa-user-lock"></i>Reset Password</button>
					</div>
				</div>
			</div>
			<div class='form-group'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					<input type='text' class='form-control' id='prefix_name' name='prefix_name' value="{prefix_text}">
					<select class='form-control' id='prefix' name='prefix' value="{prefix}">
						<option value="">- เลือก คำนำหน้า -</option>
						{members_prefix_option_list}
					</select>
				</div>
			</div>
			...
			<div class='form-group'>
				<div class='col-sm-offset-2 col-sm-10'>
					<button type="button" class='btn btn-primary btn-lg' id="btnOpenSaveDialog" data-toggle='modal' data-target='#editModal'><span class='glyphicon glyphicon-ok'></span> บันทึก</button>
				</div>
			</div>
...
<div class="modal fade" id="modal_reset_member_pass" tabindex="-1" role="dialog" aria-labelledby="modal_reset_member_pass_Label" aria-hidden="true" style="display: none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" id="formResetMemberPass">
					...
					<div class="form-group">
						<label class="col-sm-3 text-left badge badge-light" for="adminPassword">รหัสผ่านแอดมิน :</label>
						<div class="input-group">
							<input type="password" class="form-control" id="adminPassword" name="adminPassword" placeholder="รหัสผ่านแอดมิน" title="ใส่รหัสผ่านแอดมินให้ถูกต้อง เพื่อยืนยันตัวตนแอดมินผู้แก้ไข" />
							<label for="adminPassword" class="input-group-addon glyphicon glyphicon-lock"></label>
						</div> <!-- /.input-group -->
					</div> <!-- /.form-group -->
					...
					<div class="form-group">
						<div>
							<label class="col-sm-3 text-left badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
						</div>
						<div>
