...
/**
 * Members_level_model Class
 * @date 2021-10-09
 */
class Members_level_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->my_table = 'tb_members_level';
	...
	public function create($post)
	{
		...
		$data = array(
				'level_value' => $post['level_value']
				,'level_title' => $post['level_title']
		);
		$this->set_table_name($this->my_table);
