...
/**
 * Tax_receipt_percent_model Class
 * @date 2021-10-06
 */
class Tax_receipt_percent_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->my_table = 'tb_tax_receipt_percent';
	...
	public function create($post)
	{
		...
		$data = array(
				'tar_law_detail' => $post['tar_law_detail']
				,'tar_percent_detail' => str_replace(",", "", $post['tar_percent_detail'])
		);
		$this->set_table_name($this->my_table);
