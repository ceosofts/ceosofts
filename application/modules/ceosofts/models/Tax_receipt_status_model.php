...
/**
 * Tax_receipt_status_model Class
 * @date 2021-10-06
 */
class Tax_receipt_status_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->my_table = 'tb_tax_receipt_status';
	...
	public function create($post)
	{
		...
		$data = array(
				'tar_name' => $post['tar_name']
				,'tar_void' => $post['tar_void']
		);
		$this->set_table_name($this->my_table);
