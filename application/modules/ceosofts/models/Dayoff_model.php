 ...
 * @date 2021-10-08
 */
class Dayoff_model extends MY_Model
{
	...
	public function __construct()
	{
		...
		$options = array();
		$options['dayoff_id'] = array('format' => 1, 'type' => 'DAY', 'digit' => 4);
	...
	public function create($post)
	{
		...
		$data = array(
				'dayoff_id' => $post['dayoff_id']
				,'dayoff_name' => $post['dayoff_name']
				,'dayoff_date' => setDateToStandard($post['dayoff_date'])
		);
		$this->set_table_name($this->my_table);
