		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="id|asc">id น้อย - มาก</option><option value="id|desc">id มาก - น้อย</option><option value="quo_date|asc">วันที่ใบเสนอราคา เก่า - ใหม่</option><option value="quo_date|desc">วันที่ใบเสนอราคา ใหม่ - เก่า</option><option value="quo_cus|asc">ชื่อลูกค้า ก - ฮ</option><option value="quo_cus|desc">ชื่อลูกค้า ฮ - ก</option><option value="quo_project_name|asc">ชื่อโครงการ ก - ฮ</option><option value="quo_project_name|desc">ชื่อโครงการ ฮ - ก</option><option value="quo_status|asc">สถานะ ก - ฮ</option><option value="quo_status|desc">สถานะ ฮ - ก</option><option value="quo_by|asc">ผู้จัดทำเอกสาร ก - ฮ</option><option value="quo_by|desc">ผู้จัดทำเอกสาร ฮ - ก</option>
						</select>
 					</div>
				</div>
			</div>
