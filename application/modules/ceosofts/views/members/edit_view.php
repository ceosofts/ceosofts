...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>ผู้ใช้งานโปรแกรม</strong></h3>
	</div>
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="user_id" name="user_id" value="{record_user_id}" />
				</div>
			</div>
			<div class='form-group'>
