					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-userid="{encrypt_userid}" data-row-number="{record_number}">
