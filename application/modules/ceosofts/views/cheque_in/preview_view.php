...
<div class="card">
	...
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-clipboard"></i> รายละเอียด <b>เช็คเข้า</b></h3>
	</div>
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>{record_chequein_id}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>วันที่สร้างรายการ :</b></td>
						<td>{record_chequein_make_item}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>วันที่รับเช็ค :</b></td>
						<td>{record_chequein_receive_date}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>วันที่สั่งจ่าย :</b></td>
						<td>{record_chequein_plan_date}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>{preview_chequein_photo}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>หมายเหตุ :</b></td>
						<td>{record_chequein_remark}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>ผู้ทำรายการ :</b></td>
						<td>{record_chequein_user_make}</td>
					</tr>
