...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>เงินฝาก-ถอน</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{bank_balance_before}</td>
						<td>{preview_bank_action}</td>
						<td>{bank_price}</td>
						<td>{bank_balance_after}</td>
						<td>{bank_remark}</td>
						<td>
