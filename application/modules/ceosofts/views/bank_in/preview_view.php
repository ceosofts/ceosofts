...
<div class="card">
	...
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-clipboard"></i> รายละเอียด <b>เงินฝากเข้า</b></h3>
	</div>
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>{record_bank_in_id}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>วันที่ทำการ :</b></td>
						<td>{record_bank_in_date}</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="text-right fit"><b>ยอดก่อนฝาก :</b></td>
						<td>{record_bank_in_balance_before}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>ยอดทำรายการ :</b></td>
						<td>{record_bank_in_price}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>คงเหลือ :</b></td>
						<td>{record_bank_in_balance_after}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>หมายเหตุ :</b></td>
						<td>{record_bank_in_remark}</td>
					</tr>
					<tr>
						<td class="text-right fit"><b>เพิ่มข้อมูลโดย :</b></td>
						<td>{record_bank_in_edit_by}</td>
					</tr>
