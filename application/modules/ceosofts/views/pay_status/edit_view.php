...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>สถานะการจ่าย</strong></h3>
	</div>
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='name'>การชำระหนี้ :</label>
				<div class='col-sm-10'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='void'>เลขสถานะ :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="void" name="void" value="{record_void}" />
				</div>
			</div>
			<div class='form-group'>
