...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>หักภาษี</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>มาตราที่หักภาษี</th>
						<th>เปอร์เซ็นต์หักภาษี</th>
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{tar_law_detail}</td>
						<td>{tar_percent_detail}</td>
						<td>
