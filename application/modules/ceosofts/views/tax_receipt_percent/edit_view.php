...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>หักภาษี</strong></h3>
	</div>
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="tar_law_detail" name="tar_law_detail" value="{record_tar_law_detail}" />
				</div>
			</div>
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="tar_percent_detail" name="tar_percent_detail" value="{record_tar_percent_detail}" />
				</div>
			</div>
			<div class='form-group'>
