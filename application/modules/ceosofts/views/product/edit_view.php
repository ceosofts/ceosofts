		...
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="pro_id" name="pro_id" value="{record_pro_id}" readonly="readonly" />
				</div>
			</div>
			<div class='form-group'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="pro_price" name="pro_price" value="{record_pro_price}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='pro_unit'>หน่วยสินค้า :</label>
				<div class='col-sm-10'>
					<select id='pro_unit' name='pro_unit' value="{record_pro_unit}">
