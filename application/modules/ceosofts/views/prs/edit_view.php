	...
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					<select id='pr_status' name='pr_status' value="{record_pr_status}">
						<option value="">- เลือก สถานะ -</option>
						{tb_quotation_status_pr_status_option_list}
					</select>
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='pr_price'>ราคารวม :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="pr_price" name="pr_price" value="{fx_detail_grand_total_price}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='pr_by'>ผู้จัดทำเอกสาร :</label>
				<div class='col-sm-10'>
					<input type="text" class="form-control " id="pr_by" name="pr_by" value="{record_pr_by}" readonly="readonly" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='pr_edit_by'>ชื่อผู้แก้ไข :</label>
				<div class='col-sm-10'>
					<input type="text" class="form-control " id="pr_edit_by" name="pr_edit_by" value="{record_pr_edit_by}" readonly="readonly" />
				</div>
			</div>
			<div class='form-group'>
	...
	<div class="modal-dialog  modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-info">
				<h4 class="modal-title" id="addListModalLabel">เพิ่มรายการ tb_prs_list</h4>
