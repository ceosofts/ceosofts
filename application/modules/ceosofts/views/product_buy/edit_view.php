		...
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="prb_id" name="prb_id" value="{record_prb_id}" readonly="readonly" />
				</div>
			</div>
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="prb_name" name="prb_name" value="{record_prb_name}" />
				</div>
			</div>
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="prb_price" name="prb_price" value="{record_prb_price}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='prb_unit'>หน่วยสินค้า :</label>
				<div class='col-sm-10'>
					<select id='prb_unit' name='prb_unit' value="{record_prb_unit}">
