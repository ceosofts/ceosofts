...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>คำนำหน้าชื่อ</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="id|asc">ไอดี น้อย - มาก</option>
							<option value="id|desc">ไอดี มาก - น้อย</option>
						</select>
					</div>
				</div>
			</div>
