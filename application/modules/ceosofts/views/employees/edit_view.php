...
<div class="card">
	...
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='emp_time'>อายุงาน :</label>
				<div class='col-sm-10'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='emp_ss'>โรงพยาบาลประกันสังคม :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="emp_ss" name="emp_ss" value="{record_emp_ss}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='emp_welfare'>สวัสดิการเพิ่มเติม :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="emp_welfare" name="emp_welfare" value="{record_emp_welfare}" />
				</div>
			</div>
			<div class='form-group'>
