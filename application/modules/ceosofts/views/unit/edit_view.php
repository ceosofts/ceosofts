...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>หน่วยนับ</strong></h3>
	</div>
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="unit_id" name="unit_id" value="{record_unit_id}" readonly="readonly" />
				</div>
			</div>
			<div class='form-group'>
				...
				<div class='col-sm-10'>
					...
					<input type="text" class="form-control " id="unit_name" name="unit_name" value="{record_unit_name}" />
				</div>
			</div>
			<div class='form-group'>
